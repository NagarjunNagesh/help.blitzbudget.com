        ...
        <div class="page-header clear-filter">
            <div class="rellax-header rellax-header-sky">
                <div class="page-header-image"
                    style="background-image: url('img/presentation-page/nuk-pro-back-sky-green.jpg')">
                </div>
            </div>
            <div class="rellax-header rellax-header-buildings" data-rellax-speed="0">
                <div class="page-header-image page-header-city"
                    style="background-image: url('img/presentation-page/nuk-pro-buildings-green.png')">
                </div>
            </div>
            <div class="rellax-text-container rellax-text">
                <h1 class="h1-seo" data-rellax-speed="-1">Now UI Kit</h1>
            ...
            <h6 class="category category-absolute rellax-text" data-rellax-speed="-2">
                <div>
                    Designed by
                    <a href="https:///invisionapp.com/" target="_blank" rel="noopener" aria-label="Invision">
                        <img v-lazy="'img/invision-white-slim.png'" class="invision-logo" alt="" />
                    </a>. Coded by
                    <a href="https://www.creative-tim.com" target="_blank" rel="noopener" aria-label="Creative Tim">
                        <img v-lazy="'img/creative-tim-white-slim2.png'" class="creative-tim-logo" alt="" />
                    </a>.
                </div>
            </h6>
        </div>
        <div class="section section-components" data-background-color="dark-green">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto">
                        <h2 class="text-center title">Impressive collection of elements
                            <br>
                            <small class="description text-white">Designed to look gorgeous together</small>
                        </h2>
                        <h5 class="text-center description text-white">Now UI Kit Pro comes with a huge number of
                            customisable
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card-container first-card">
                            <div class="card-component">
                                <nuxt-link to="/components" target="_blank" rel="noopener">
                                    <div class="front">
                    ...
                    <div class="col-md-3">
                        <div class="card-container second-card">
                            <div class="card-component">
                                <nuxt-link to="/components#cards" target="_blank" rel="noopener">
                                    <div class="front">
                    ...
                    <div class="col-md-3">
                        <div class="card-container third-card">
                            <div class="card-component">
                                <nuxt-link to="/sections" target="_blank" rel="noopener">
                                    <div class="front">
                    ...
                    <div class="col-md-3">
                        <div class="card-container fourth-card">
                            <div class="card-component">
                                <nuxt-link to="/product" target="_blank" rel="noopener">
                                    <div class="front">
                ...
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="section-description text-center">
                        ...
                        <h5 class="description"> Build pages in no time using pre-made sections! From headers to
                            ...
                            pages.</h5>
                        <nuxt-link to="/sections" target="_blank" rel="noopener" class="btn btn-success btn-round">View
                            All Sections</nuxt-link>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <nuxt-link to="/about" target="_blank" rel="noopener" aria-label="about us link">
                                <img v-lazy="'img/presentation-page/pages/about-us.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Landing Page</h5>
                        <div class="card">
                            <nuxt-link to="/landing" target="_blank" rel="noopener" aria-label="landing page link">
                                <img v-lazy="'img/presentation-page/pages/landing.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Login Page</h5>
                        <div class="card">
                            <nuxt-link to="/login" target="_blank" rel="noopener" aria-label="login link">
                                <img v-lazy="'img/presentation-page/pages/login.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Signup Page</h5>
                        <div class="card">
                            <nuxt-link to="/signup" target="_blank" rel="noopener" aria-label="sign up link">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <nuxt-link to="/blog-post" target="_blank" aria-label="blog post link">
                                <img v-lazy="'img/presentation-page/pages/blog-post.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Product Page</h5>
                        <div class="card">
                            <nuxt-link to="/product" target="_blank" aria-label="product link">
                                <img v-lazy="'img/presentation-page/pages/product.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Profile Page</h5>
                        <div class="card">
                            <nuxt-link to="/profile" target="_blank" aria-label="profile link">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <nuxt-link to="/pricing" target="_blank" aria-label="pricing link">
                                <img v-lazy="'img/presentation-page/pages/pricing.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Ecommerce</h5>
                        <div class="card">
                            <nuxt-link to="/ecommerce" target="_blank" aria-label="ecommerce link">
                                <img v-lazy="'img/presentation-page/pages/ecommerce.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Blog Posts</h5>
                        <div class="card">
                            <nuxt-link to="/blog-posts" target="_blank" aria-label="blog posts link">
                                <img v-lazy="'img/presentation-page/pages/blog-posts.jpg'" alt="">
                            </nuxt-link>
                        </div>
                        <h5 class="title">Contact Us</h5>
                        <div class="card">
                            <nuxt-link to="/contact" target="_blank" aria-label="contact link">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <h5 class="description">
                            ...
                            <a href="https://nucleoapp.com/?ref=1712" target="_blank" rel="noopener">NucleoApp</a>. The
                            official
                        ...
                        <a href="https:///demos.creative-tim.com/now-ui-kit-pro/nucleo-icons.html"
                            class="btn btn-success btn-round btn-lg " target="_blank" rel="noopener">View Demo
                            Icons</a>
                        <a href="https://nucleoapp.com/?ref=1712" rel="noopener"
                            class="btn btn-outline-primary btn-round btn-lg " target="_blank">View All Icons</a>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 px-0">
                        <div class="col-sm-12">
                            <info-section title="Save Time & Money" icon="now-ui-icons business_money-coins"
                            ...
                            <info-section title="Bootstrap 4 & Flexbox" icon="now-ui-icons text_bold" description="It is built over Bootstrap 4, it's fully responsive and has
                            ...
                            <info-section title="Fast Prototype" icon="now-ui-icons education_paper" description="Using Now UI Kit PRO you can create hundreds of components
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <p class="description mb-5 text-center">You have
                            ...
                            <br> Read more about
                            <b>
                                <a href="https://www.creative-tim.com/license" target="_blank" rel="noopener">licenses
                                    here</a>
                            </b>.
                        </p>
                        <div class="row">
                            <div class="col-md-6">
                                <card type="background" raised class="card-pricing card-margin"
                                    ...
                                    <a href="https://www.creative-tim.com/buy/nuxt-now-ui-kit-pro?license=1"
                            ...
                            <div class="col-md-6">
                                <card type="background" raised class="card-pricing"
                                    ...
                                    <a href="https://www.creative-tim.com/buy/nuxt-now-ui-kit-pro?license=2"
                                        class="btn btn-success btn-round">
                                        Buy Now!
                                    </a>
                                </card>
