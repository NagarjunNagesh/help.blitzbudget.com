<template>
  <div class="wrapper blog-post">
    <div class="page-header page-header-small rellax-header">
      <div class="page-header-image" style="background-image: url('img/bg35.jpg')"></div>
      <div class="content-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">Delete Budget</h2>
            <h4>Help Center</h4>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <br>
              <br>
              <img src="img/gifs/budget/delete-budget.gif" alt="Budget">
              <br>
              <br>
              At times the category can become redundant or stale at which point we can delete the category by
              clicking on the <i>"Delete"</i> (X) icon available in every category that you have.
              <br>
              <br>
