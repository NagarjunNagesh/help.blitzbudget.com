      ...
      <div class="content-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">Edit Investment</h2>
            <h4>Help Center</h4>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <h3 class="title">Edit Investment</h3>
              <br>
              <br>
              <img src="img/gifs/investment/edit-investment.gif" alt="Edit Investment">
              <br>
              <br>
              Edit Investment can be used to edit the <strong>current invested amount</strong> or <strong>the current
                value</strong> of the invested
              amount along with the name of the investment.
              <br>
              <br>
