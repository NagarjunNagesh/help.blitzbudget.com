<template>
  <div class="wrapper blog-post">
    <div class="page-header page-header-small rellax-header">
      <div class="page-header-image" style="background-image: url('img/bg19.jpg')"></div>
      <div class="content-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">Delete Investment</h2>
            <h4>Help Center</h4>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <br>
              <br>
              At times the investment can become redundant or stale at which point we can delete the investment by
              clicking on the <i>"Delete"</i> (X) icon available in every investment that you have.
              <br>
              <br>
