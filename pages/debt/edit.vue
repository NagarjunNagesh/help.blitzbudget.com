        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <h3 class="title">Edit Debt</h3>
              <br>
              <br>
              <img src="img/gifs/debt/edit-debt.gif" alt="Budget">
              <br>
              <br>
              Edit Debt can be used to edit the <strong>debt repaid</strong> or <strong>debted amount</strong> along
              with the name of the debt.
              <br>
              <br>
